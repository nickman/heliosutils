...
public class AgentInstrumentation extends NotificationBroadcasterSupport implements AgentInstrumentationMBean {
	...
	/** Static class logger */
	private final static Logger log = Logger.getLogger(AgentInstrumentation.class.getName()); 
	...
	public static void premain(String agentArgs, Instrumentation inst) {
		...
		log.info("Loading AgentInstrumentation MBean");
		...
		try {
			...
			log.info("AgentInstrumentation MBean Loaded");
		} catch (Exception e) {
...
//		log.info("Retransformable [" + clazz.getName() + "]:" + this.isModifiableClass(clazz));
...
//		if(bytecode==null) {
//			log.info("Failed to Generate ByteCode for class [" + clazz.getName() + "]");
//		} else {
//			log.info("Generated ByteCode for class [" + clazz.getName() + "] --> [" + bytecode.length + "] Bytes.");
//		}
//		
//		return bytecode;
//	}
	...
	public void retransformClasses(Class<?>... classes) throws UnmodifiableClassException {
		log.info("Retransforming [" + classes[0].getName() + "]");
