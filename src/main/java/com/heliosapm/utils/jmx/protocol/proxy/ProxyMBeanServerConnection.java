...
/**
 * <p>Title: ProxyMBeanServerConnection</p>
 * <p>Description: </p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.heliosapm.utils.jmx.protocol.proxy.ProxyMBeanServerConnection</code></p>
 */

public class ProxyMBeanServerConnection implements ProxyMBeanServerConnectionMBean {
	/** The delegate connection */
	private final MBeanServerConnection delegate;
	/** The delegate connection's jmx connector */
	private final JMXConnector jmxConnector;
	/** The connection id */
	private final String connectionId;
	
	/**
	 * Creates a new ProxyMBeanServerConnection
	 */
	public ProxyMBeanServerConnection(final JMXConnector jmxConnector) {
		...
		try {
			...
			try {
				...
				throw new RuntimeException("Failed to get MBeanServerConnection from connector [" + jmxConnector + "]", ex);
			}
		}
		delegate = conn;
		...
		try {
			...
			throw new RuntimeException("Failed to get connection id from connector [" + jmxConnector + "]", ex);
		}
	}
