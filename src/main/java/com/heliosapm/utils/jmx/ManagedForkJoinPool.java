 ...
 * <p>Description: A JMX managed fork join pool</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.heliosapm.utils.jmx.ManagedForkJoinPool</code></p>
 */
public class ManagedForkJoinPool extends ForkJoinPool implements ManagedForkJoinPoolMXBean {
	...
	/** Static class logger */
	protected static final Logger log = Logger.getLogger(ManagedForkJoinPool.class.getName());
		...
		super(
			...
			new UncaughtExceptionHandler(){
				...
				public void uncaughtException(final Thread t, final Throwable e) {					
					log.log(Level.SEVERE, "Uncaught Exception in ManagedForkJoinPool [" + name + "] on Thread ["+ t + "]", e);
				}
			}, 
			asyncMode
		);
