 ...
 * <p>Description: JMX MBean interface for the JVM's {@link Instrumentation} instance.</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.heliosapm.utils.instrumentation.InstrumentationMBean</code></p>
 */

public interface InstrumentationMBean {
	
	/** The MBean's JMX ObjectName */
	public static final ObjectName OBJECT_NAME = JMXHelper.objectName("com.heliosapm:service=Instrumentation");
