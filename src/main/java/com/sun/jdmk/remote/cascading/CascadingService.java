...
public class CascadingService implements CascadingServiceMBean,
    ...
    /**
     * {@inheritDoc}
     * @see com.sun.jdmk.remote.cascading.CascadingServiceMBean#mount(java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    public String mount(final String sourceURL, final String sourcePattern, final String targetPath) throws IOException, InstanceAlreadyExistsException {    	
    	return mount(JMXHelper.serviceUrl(sourceURL), null, JMXHelper.objectName(sourcePattern==null ? "*:*" : sourcePattern.trim()), targetPath);
    }
