...
public interface CascadingServiceMBean {
    ...
    /**
     * Mounts a foreign MBeanServer
     * @param sourceURL The JMXServiceURL
     * @param sourcePattern The ObjectName pattern to expose
     * @param targetPath The target path the MBeanServer should be mounted under
     * @return A <var>mountPointID</var> identifying this mount operation.
     *         This mountPointID must be later used to call {@link #unmount}. 
     * @throws IOException thrown on any IO error
     * @throws InstanceAlreadyExistsException thrown if the mount point already exists
     */
    public String mount(String sourceURL, String sourcePattern, String targetPath) 
	throws IOException, InstanceAlreadyExistsException;
